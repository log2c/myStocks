    ...
    static const TranslationMap kTranslations = {
        {
            "en_US",
            {
                ...
                {"settings.general.opacity", "Window opacity"},
                {"settings.general.hotkey", "Toggle hotkey"},
                {"settings.general.hotkeyHint", "Leave empty to disable"},
        ...
        },
        {
            "zh_CN",
            {
                ...
                {"settings.general.opacity", "窗口透明度"},
                {"settings.general.hotkey", "切换热键"},
                {"settings.general.hotkeyHint", "留空则禁用"},
